...
HD_PWD='/home/goma/Documents/Work/AES/RUN/AES/AES.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log timing_tester.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source timing_tester.tcl
