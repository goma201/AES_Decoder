...
HD_PWD='/home/goma/Documents/Work/AES/RUN/AES/AES.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log timing_tester.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source timing_tester.tcl -notrace
